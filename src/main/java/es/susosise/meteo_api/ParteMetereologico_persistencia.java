...
public interface ParteMetereologico_persistencia extends JpaRepository<ParteMetereologico_entidad, Long> {
    ...
    List<ParteMetereologico_entidad> findTop10ByOrderByFechaDesc();
